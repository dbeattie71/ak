...
{
	/// <summary>
	/// Summary description for frmTravelPath.
	/// </summary>
	public class frmTravelPath : System.Windows.Forms.Form, IProfileForm
	{
		...
		private void InitializeComponent() {
			...
			// btnAddPatrolArea
			// 
			this.btnAddPatrolArea.Location = new System.Drawing.Point(144, 29);
			this.btnAddPatrolArea.Name = "btnAddPatrolArea";
			this.btnAddPatrolArea.Size = new System.Drawing.Size(59, 20);
			this.btnAddPatrolArea.TabIndex = 20;
			this.btnAddPatrolArea.Text = "Add Path";
			this.toolTip1.SetToolTip(this.btnAddPatrolArea, "Add a new Travel Path using the name entered");
			...
			this.panel5.Size = new System.Drawing.Size(336, 244);
			...
			this.lvwPatrolArea.Location = new System.Drawing.Point(8, 40);
			this.lvwPatrolArea.Name = "lvwPatrolArea";
			this.lvwPatrolArea.Size = new System.Drawing.Size(320, 192);
			...
			// btnWaypointMoveUp
			// 
			this.btnWaypointMoveUp.Location = new System.Drawing.Point(184, 8);
			this.btnWaypointMoveUp.Name = "btnWaypointMoveUp";
			this.btnWaypointMoveUp.Size = new System.Drawing.Size(64, 22);
			...
			this.cbxPatrolAreas.Location = new System.Drawing.Point(8, 8);
			...
			// btnDeletePatrolArea
			// 
			this.btnDeletePatrolArea.Location = new System.Drawing.Point(208, 29);
			this.btnDeletePatrolArea.Name = "btnDeletePatrolArea";
			this.btnDeletePatrolArea.Size = new System.Drawing.Size(119, 20);
			this.btnDeletePatrolArea.TabIndex = 19;
			this.btnDeletePatrolArea.Text = "Delete Selected Path";
			this.toolTip1.SetToolTip(this.btnDeletePatrolArea, "Delete the selected Travel Path");
			...
			this.label1.Text = "Create or Select a Waypoint Path";
			...
			this.Name = "frmTravelPath";
			this.Text = "frmTravelPath";
		...
		#region Travel Path to add and delete
		...
		private void btnAddPatrolArea_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				_patrolareas.AddPatrolArea(frm.txtPatrolAreaName.Text, PatrolType.TravelPath );			
			}
			catch(Exception E)
			{
		...
		private void btnDeletePatrolArea_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Please select the Travel Path to delete first.", "Path Delete Error",
					MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				return;
			}
		...
		private void cbxPatrolAreas_SelectedIndexChanged(object sender, EventArgs e)
		{
			if( UpdateVariable != null)
				UpdateVariable( "CorpseRun", cbxPatrolAreas.Text);
		...
		private void LoadSettings(string areaName)
		{
			...
			lock(waypoints.SyncRoot)
			{
				foreach (Waypoint wpt in waypoints)
				{
					...
					lvi.SubItems.Add(wpt.X.ToString());
					lvi.SubItems.Add(wpt.Y.ToString());
					lvi.Tag = wpt;
		...
		{
			profile.DefineVariable( "CorpseRun", "");
		}
		...
		public void OnProfileChange( Profile profile)
		{
			...
			for( int i = 0; i < cbxPatrolAreas.Items.Count; i ++)
				if( (string)cbxPatrolAreas.Items[i] == profile.GetString("CorpseRun"))
				{
